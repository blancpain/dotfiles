...
usage() {
  cat <<'EOF'
Usage: scripts/bootstrap-macos-non-nix-corporate.sh

Automates a fresh macOS setup WITHOUT Nix (corporate/BYOD machine):
...
BREWFILE="${REPO_ROOT}/brew/Brewfile.corporate"
...
install_packages() {
  ...
  info "Installing packages from Brewfile.corporate (this may take a while)."
