...
abbr p python3
abbr pv uv venv
abbr pa source .venv/bin/activate.fish

# Platform-specific abbreviations
if test $IS_MACOS -eq 1
    abbr c "pwd | pbcopy"
    abbr bu "brew update && brew upgrade"
    abbr bbc "brew bundle --file=~/dotfiles/brew/Brewfile.corporate"
    abbr bbp "brew bundle --file=~/dotfiles/brew/Brewfile.personal"
