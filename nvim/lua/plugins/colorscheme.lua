  ...
  -- },
  {
    ...
    opts = {
      ...
      overrides = {
        ...
        NavicText = { bg = "#44475a", fg = "white" },
        NavicSeparator = { bg = "#44475a", fg = "white" },
        Navic = { bg = "#44475a" },
        NavicIconsText = { bg = "#44475a", fg = "white" },
        NavicIconsKey = { bg = "#44475a", fg = "white" },
        NavicIconsEnum = { bg = "#44475a", fg = "white" },
        NavicIconsFile = { bg = "#44475a", fg = "white" },
        NavicIconsNull = { bg = "#44475a", fg = "white" },
        NavicIconsArray = { bg = "#44475a", fg = "white" },
        NavicIconsClass = { bg = "#44475a", fg = "white" },
        NavicIconsEvent = { bg = "#44475a", fg = "white" },
        NavicIconsField = { bg = "#44475a", fg = "white" },
        NavicIconsMethod = { bg = "#44475a", fg = "white" },
        NavicIconsModule = { bg = "#44475a", fg = "white" },
        NavicIconsNumber = { bg = "#44475a", fg = "white" },
        NavicIconsObject = { bg = "#44475a", fg = "white" },
        NavicIconsString = { bg = "#44475a", fg = "white" },
        NavicIconsStruct = { bg = "#44475a", fg = "white" },
        NavicIconsBoolean = { bg = "#44475a", fg = "white" },
        NavicIconsPackage = { bg = "#44475a", fg = "white" },
        NavicIconsConstant = { bg = "#44475a", fg = "white" },
        NavicIconsFunction = { bg = "#44475a", fg = "white" },
        NavicIconsOperator = { bg = "#44475a", fg = "white" },
        NavicIconsProperty = { bg = "#44475a", fg = "white" },
        NavicIconsVariable = { bg = "#44475a", fg = "white" },
        NavicIconsInterface = { bg = "#44475a", fg = "white" },
        NavicIconsNamespace = { bg = "#44475a", fg = "white" },
        NavicIconsEnumMember = { bg = "#44475a", fg = "white" },
        NavicIconsConstructor = { bg = "#44475a", fg = "white" },
        NavicIconsTypeParameter = { bg = "#44475a", fg = "white" },
      },
    },
  },
  {
    ...
    opts = {
      ...
      integrations = {
        navic = {
          enabled = true,
          custom_bg = "red", -- "lualine" will set background to mantle
        },
      },
